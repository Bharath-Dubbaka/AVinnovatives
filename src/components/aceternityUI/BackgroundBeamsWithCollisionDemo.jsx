   ...
   return (
      <BackgroundBeamsWithCollision>
         <h2 className="relative z-20 md:text-4xl lg:text-7xl font-bold text-center text-black dark:text-white font-sans tracking-tight">
            Coworking Spaces Redefined{" "}
            <div className="relative mx-auto inline-block w-max [filter:drop-shadow(0px_1px_3px_rgba(27,_37,_80,_0.14))]">
               <div className="absolute left-0 top-[1px] bg-clip-text bg-no-repeat text-transparent bg-gradient-to-r py-4 from-purple-500 via-violet-500 to-pink-500 [text-shadow:0_0_rgba(0,0,0,0.1)]">
                  <span className="">by AVinnovations.</span>
               </div>
...
export const BackgroundBeamsWithCollision = ({ children, className }) => {
   ...
   return (
      <div
         ref={parentRef}
         className={cn(
            "h-60 md:h-80 relative flex items-center w-full justify-center overflow-hidden border-b  border-neutral-100",
